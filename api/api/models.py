...
categories = ['Reading', 'Movies', 'Photography', 'Programming', 'Writing', 'Poetry', 'Rhetoric/Speech', 'Music', 'Singing', 'Cooking', 'Sports', 'Engineering', 'Painting', 'Foodie', 'Driving', 'Traveling', 'Cinematography',
...
class User(db.Model):
    ...
    def remove_interest(self, interest):
        if interest in maskCategories:
            self.interests = self.interests[:maskCategories[interest]
                                            ] + "0" + self.interests[maskCategories[interest]+1:]

    def add_interest(self, interest):
        if interest in maskCategories:
            self.interests = self.interests[:maskCategories[interest]
                                            ] + "1" + self.interests[maskCategories[interest]+1:]
