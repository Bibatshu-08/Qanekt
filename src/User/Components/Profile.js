    ...
    <div className="profile">
      ...
      {/* this div consists of name, age, and gender  */}
        <div className="layer-one">
          <div className="name">
            <form action="">
              <label for="user_name"><h3>First name:</h3></label>
        ...
        <div className="layer-three">
          <label for="story"><h3>What is your unique story?</h3></label>
          <textarea name="story" id="story" required wrap autofocus placeholder="This is your opportunity to discuss more about your interests in detail . . ."></textarea>
        </div>
